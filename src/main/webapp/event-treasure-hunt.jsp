<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Treasure Hunt - ITYUKTA 2K26</title>
        <meta name="description" content="Treasure Hunt - An exciting campus-wide adventure at ITYUKTA 2K26.">
        ...
        <main style="padding-top: 0;">
            <div class="event-page-hero">
                <div>
                    ...
                    <div class="event-page-icon">🗺️</div>
            ...
            <div class="event-detail-section">
                ...
                <p>Treasure Hunt is an exciting campus-wide adventure where teams follow a trail of cryptic clues,
                    riddles, and puzzles to discover the hidden treasure. It's a test of teamwork, quick thinking, and
            ...
            <div class="event-detail-section">
                ...
                <ul>
                    ...
                    <li>Multiple checkpoints across the campus</li>
                    <li>Each checkpoint has a riddle or puzzle to solve</li>
                    <li>First team to find the treasure wins</li>
                    <li>No mobile phones allowed during the hunt</li>
                </ul>
            </div>
            <div class="event-detail-section" id="register">
                <div class="register-cta">
                    <h2>Ready for the Adventure?</h2>
                    <p>Register now and begin the hunt!</p>
                    <a href="register.jsp?event=treasure-hunt" class="btn-register">Register Now <svg width="16"
