<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Runtime Rush - ITYUKTA 2K26</title>
        <meta name="description" content="Runtime Rush - A speed coding competition at ITYUKTA 2K26.">
        ...
        <main style="padding-top: 0;">
            <div class="event-page-hero">
                <div>
                    ...
                    <h1>Runtime Rush</h1>
                    <p>Race against time to write the most efficient code. Speed, accuracy, and optimization matter!</p>
                </div>
            </div>
            ...
            <div class="event-detail-section">
                ...
                <p>Runtime Rush is a high-intensity speed coding competition where every millisecond counts. Write
                    clean, optimized code under extreme time pressure. The fastest coder with the most accurate
                    solutions wins!</p>
            </div>
            <div class="event-detail-section">
                <h2>Rules & Format</h2>
                <ul>
                    ...
                    <li>Multiple coding problems with increasing difficulty</li>
                    <li>Solutions judged on correctness, speed, and code efficiency</li>
                    <li>Languages allowed: C, C++, Java, Python</li>
                    <li>No copy-paste from external sources</li>
                </ul>
            </div>
            <div class="event-detail-section" id="register">
                <div class="register-cta">
                    <h2>Think You're Fast Enough?</h2>
                    <p>Register now and prove your speed in Runtime Rush!</p>
                    <a href="register.jsp?event=runtime-rush" class="btn-register">Register Now <svg width="16"
